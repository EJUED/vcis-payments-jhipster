...
public class InvoiceResource {
    ...
    private static final String ENTITY_NAME = "sobeAquiJHipsterInvoice";
        ...
        Optional<Invoice> result = invoiceRepository
            ...
            .map(existingInvoice -> {
                if (invoice.gets3Url() != null) {
                    existingInvoice.sets3Url(invoice.gets3Url());
                }
                if (invoice.getValue() != null) {
                    existingInvoice.setValue(invoice.getValue());
                }
                if (invoice.getCreationDate() != null) {
                    existingInvoice.setCreationDate(invoice.getCreationDate());
                }
