...
class InvoiceResourceIT {
    ...
    private static final InvoicesStatusEnum DEFAULT_INVOICE_STATUS = InvoicesStatusEnum.Send;
    private static final InvoicesStatusEnum UPDATED_INVOICE_STATUS = InvoicesStatusEnum.Approved;
    ...
    void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.gets3Url()).isEqualTo(DEFAULT_S_3_URL);
        assertThat(testInvoice.getValue()).isEqualTo(DEFAULT_VALUE);
    ...
    void putExistingInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.gets3Url()).isEqualTo(UPDATED_S_3_URL);
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.creationDate(UPDATED_CREATION_DATE);
