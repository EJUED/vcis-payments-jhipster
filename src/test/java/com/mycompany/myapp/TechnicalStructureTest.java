...
@AnalyzeClasses(packagesOf = SobeAquiJHipsterApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(SobeAquiJHipsterApp.class), alwaysTrue())
